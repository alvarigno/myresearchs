...
namespace DirectoryMonitorWinForm
{
	...
	public class DirectoryMonitorForm : System.Windows.Forms.Form
	{
        ...
        private System.Windows.Forms.TextBox ListEventFileMine;
		...
		private void InitializeComponent()
		{
            ...
            this.ListEventFileMine = new System.Windows.Forms.TextBox();
            ...
            this.ButtonStart.Size = new System.Drawing.Size(64, 26);
            ...
            this.ButtonStop.Size = new System.Drawing.Size(64, 26);
    ...
    " monitor.  Click \"Stop\" to end the monitor.";
            ...
            // ListEventFileMine
            // 
            this.ListEventFileMine.Location = new System.Drawing.Point(19, 219);
            this.ListEventFileMine.Multiline = true;
            this.ListEventFileMine.Name = "ListEventFileMine";
            this.ListEventFileMine.Size = new System.Drawing.Size(381, 359);
            this.ListEventFileMine.TabIndex = 10;
            // 
            // DirectoryMonitorForm
            // 
            this.AutoScaleBaseSize = new System.Drawing.Size(5, 13);
            this.ClientSize = new System.Drawing.Size(416, 608);
            this.Controls.Add(this.ListEventFileMine);
		...
		private void FileMonitor_OnRenamed(object source, RenamedEventArgs e)
		{
            ...
            ListEventFileMine.Text = "File: " + originalname + " renamed to " + renamed +" "+ e.OldName + " Renamed";
        }
		...
		private void FileMonitor_Changed(object sender, System.IO.FileSystemEventArgs e)
		{
			...
			if (ChangeType=="Created")
			{
                ...
                ListEventFileMine.Text = "File: " + e.FullPath + " " + e.ChangeType +" "+ e.Name + " Created";

            }
			else if(ChangeType=="Deleted")
			{
				//MessageBox.Show("File: " +  e.FullPath + " " + e.ChangeType, e.Name+" Deleted");
                ListEventFileMine.Text = "File: " + e.FullPath + " " + e.ChangeType + " " + e.Name + " Deleted";
            }
			else if(ChangeType=="Changed")
			{
				//MessageBox.Show("File: " +  e.FullPath + " " + e.ChangeType, e.Name+" Changed");
                ListEventFileMine.Text = "File: " + e.FullPath + " " + e.ChangeType + " " + e.Name + " Changed";
            }
