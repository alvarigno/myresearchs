							...
							<div class="row">
                                <div class="col-sm-12 form-row">
                                    <div class="form-group">
										...
										-->
                                        <INPUT TYPE="HIDDEN" ID="TBK_URL_EXITO" NAME="TBK_URL_EXITO" class="form-control" runat="server" /> <BR>
										<INPUT TYPE="HIDDEN" ID="TBK_URL_FRACASO" NAME="TBK_URL_FRACASO" class="form-control" runat="server" /> <BR>
                                            
                                        
                                    </div>
                                </div>
                            </div>
                            <INPUT TYPE="HIDDEN" ID="TBK_URL_FORM" NAME="TBK_URL_FORM" class="form-control" runat="server" />
