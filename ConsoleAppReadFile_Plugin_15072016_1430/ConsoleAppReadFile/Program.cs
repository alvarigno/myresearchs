    ...
    class Program
    {
        ...
        public static bool insertondatabase()
        {
            ...
            try
            {
                ...
                //Codifica mail en formato UTF-8
                string borrame = DatoRemitenteMail.ToString();
                Console.WriteLine("dATO REMITENTE ANTES DE CODIFICAR: " + borrame);

                Console.WriteLine("Es non - ANSI: " + ContainsUnicodeCharacter(borrame));

                Console.WriteLine("Es non - ANSI: " + GetASCIIvar(borrame));

                borrame = pruebaborrame(borrame);
                Console.WriteLine("pruebaborrame: "+ borrame);

                borrame = pruebaborrame2(borrame);
                Console.WriteLine("pruebaborrame2: " + borrame);

                borrame = ChangeEncodingFormat(borrame);
                Console.WriteLine("Formato final: " + borrame);
