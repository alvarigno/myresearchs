...
namespace publicacionCA_DM_CefSharp
{
    public partial class frmPrincipal : Form
    {
        ...
        //captura datos de los enlaces - obtiene el nombre de fantasia.
        ...
        private void copiarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            /*
             *     Inyección de código para carga de fotos masiva en demotores
            */
            if (ScriptCargado == false) //Si no se ha cargado
            {
                frmDM.browserDM.ExecuteScriptAsync(@"var totFiles = 0;
                   ...
                   $('#divFotos').remove();
                   $('.fotos-txt').remove();
                   $('#fotos').append('<div><input type=""file"" id=""upload"" multiple></div><div id=""wrap-fotos"" style=""float:left;width:520px;height:500px;""></div>');
                       ...
                       for (var i = 0, len = e.target.files.length; i < len; i++) {
                           (function(file, eliminar) {
                               ...
                               $.ajax({
                                   ...
                                   console.log(r);
                                   totFiles++;
                                   $('#wrap-fotos').append('<div class=""item-fotos"" style=""width:90px;height:85px;float:left;margin:2px 2px;""><img style=""width:100%;height:80%;"" src=""http://images.demotores.cl/post/tmp/siteposting/'+r+'""><div class=""del-item-foto"" style=""margin-top: -12px;"" onclick=""eliminar(this)"">eliminar</div></div>');
            ...
            task.ContinueWith(tskPatente =>
            {
                ...
                if (response.Success && response.Result.ToString() != "")
                {
                    ...
                    strJavascript = "if (document.getElementById('licensePlate')) {";
                    strJavascript += " document.getElementById('licensePlate').value ='" + caPub.patente + "';";
                    strJavascript = "}";
        ...
        private void publicarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmCA.browserCA.ExecuteScriptAsync(strJavascript);
