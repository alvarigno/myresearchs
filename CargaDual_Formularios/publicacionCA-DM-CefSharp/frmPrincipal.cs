    ...
    public partial class frmPrincipal : Form
    {
        ...
        public class BoundObject
        {
            ...
            public void CargaMarca(string dato) {
                ...
                {
                    string strJavascript = " document.getElementById('msj-brands-error').className = 'msj-error';";
            ...
            public void CargaModelo(string dato)
            {
                ...
                {
                    string strJavascript = "if (document.getElementById('models')) {";
                    strJavascript += "  document.getElementById('msj-models-error').className = 'msj-error';";
            ...
            public void ActivaBotonPublicar()
            {

                frmDM.browserDM.ExecuteScriptAsync(@"$('#_eventId_continue').removeAttr('disabled');");
        ...
        private void publicarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmCA.browserCA.ExecuteScriptAsync(@"$('#btnsub').click();$('#btnsub').css({ 'display': 'none'});");
            frmDM.browserDM.ExecuteScriptAsync(@"$('#_eventId_continue').click();$('#_eventId_continue').css({ 'display': 'none'});");
            ScriptCargado = false;
        ...
        /// <summary>
        /// Carga el listado de imagenes al servidor de DeMotores.
        /// </summary>
        ...
        private void cargarImagenesToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void copiarToolStripMenuItem1_Click(object sender, EventArgs e)
            {
                ...
                */
                ...
                if (imgcargadasenservidordm != null)
                {
                    ...
                    frmDM.browserDM.ExecuteScriptAsync("$('#fotos').find('#wrap-fotos').empty();");
